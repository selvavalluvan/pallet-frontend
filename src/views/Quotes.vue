      ...
      <div class="col-md-10 right-panel-scroll">
        <div class="carriers-main-page">
          <div class="row align-items-center justify-content-center">
            ...
            <div class="col-lg-7">
              <span class="quotes-title">Quotes</span>
              <router-link to="/viewallquotes">
                <base-button type="primary" class="add-carriers-btn">
                  VIEW ALL QUOTES
                </base-button>
              </router-link>
            </div>
          ...
          <div class="row filter-button">
            ...
            >
            <base-button type="success" class="common-btn-margin"
              >Follow Up</base-button
            >
            ...
            <base-dropdown>
              ...
              >
                <span class="nav-link-inner--text"
                  >Change Selected Quote Status</span
                >
              </a>
          ...
          <div class="row accepted-quotes">
            <div class="col-md-12">
              <accepted-quotes-table></accepted-quotes-table>
            </div>
          </div>

          <div class="row accepted-quotes">
            <div class="col-md-12">
              <quotes-under-review-table></quotes-under-review-table>
            </div>
          </div>
        </div>
      </div>
...
import AcceptedQuotesTable from "./components/Tables/AcceptedQuotesTable.vue";
import QuotesUnderReviewTable from "./components/Tables/QuotesUnderReviewTable.vue";
...
.quotes-page .nav.btn-group li a:not(.active) {
